...
I put a lot of completely unpaid effort and time (since I'm a student hardcore procrastinating his thesis writing) into making this book and I give it to you for free, hoping it will save you a lot of time and make you a better or at least a more efficient researcher. 
    <!-- Spendenbutton https://www.paypal.com/de/cgi-bin/webscr?cmd=_donate-intro-outside -->

I though have on request for you: Everyone whom this book helped I want to invite to contribute to this project as ideas and resolutions, that would make this book continously better come during actual thesis writing.
...
- To open and use this book's project just download it's source files (`zip` from toolbar on top)^[GitHub links will follow (_tbd_)] and open the `.Rproj`-file in RStudio (of course you need R and RStudio).
